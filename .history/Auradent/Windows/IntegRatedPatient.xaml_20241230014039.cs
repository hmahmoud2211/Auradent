...
{
    public partial class IntegRatedPatient : AutoRefreshWindow
    {
        ...
        private void FinanceBtn(object sender, RoutedEventArgs e)
        {
            ...
            patient_Finance.SetPatient(_patient);
            patient_Finance.WindowState = WindowState.Normal;
            patient_Finance.Title = "Patient Finance - " + _patient.PatientName;
