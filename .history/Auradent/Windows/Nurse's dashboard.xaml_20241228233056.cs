    ...
    public partial class Nurse_s_dashboard : Window
    {
        ...
        private void UpdateCurrentMonthYear()
        {
            if (mainCalendar.DisplayDate != null)
            {
                ...
                foreach (Button btn in ((StackPanel)((WrapPanel)currentYearButton.Parent).Parent).Children)
                {
                ...
                foreach (Button btn in ((WrapPanel)((Button)FindName("currentYearButton")).Parent.Parent).Children)
                {
