...
namespace Auradent.Windows
{
    ...
    public partial class Report : Window
    {
        ...
        private void PatientControl_ViewReportClicked(object sender, RoutedEventArgs e)
        {
            var patientControl = sender as View.Usercontrols.Patient;
            if (patientControl?.Tag is Patient patient)
            {
                var medicalRecord = _medicalRecordHelper.GetAllData()
                    .FirstOrDefault(m => m.RecordId == patient.MedicalRecordID);
